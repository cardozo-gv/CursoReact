...
function AlbumCard(props){
	return(
		<Card className={props.classes.item} onClick={()=>props.setAlbum(props.album)}>
			<CardMedia className={props.classes.media} image={props.album.coverPhotoBaseUrl}></CardMedia>
			<CardContent>
				<Typography variant='h5' component='h2' glutterBottom>{props.album.title}</Typography>
				<Typography variant='p'>{props.album.mediaItemsCount} foto(s)</Typography>
			</CardContent>
